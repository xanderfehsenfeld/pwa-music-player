...
class Detail extends PureComponent {
  ...
  onLinkClick = () => {
    console.log(this.props.track.permalink_url)
        ...
        <div className="detail__track" aria-live="polite" aria-atomic="false">
          ...
          <div className="detail__controls">
            ...
            <div className="detail__timing">
              ...
              <time className="time">
                {convertSecondsToMMss(this.props.track.duration / 1000)}
              </time>
            </div>
            <div className="detail__buttons">
              <IconButton
                ...
                className={`icon-button ${
                  this.props.repeat ? 'icon-button--high-light' : ''
                }`}
              ...
              <MediaButton
                ...
                className="pause"
                tabEnabled={this.props.active}
                active={this.props.track.playing && !this.props.track.paused}
                onClick={this.onPauseClick}
                icon={<PauseButton width={24} />}
              />
              <MediaButton
                name="play button"
                className="play"
              ...
              <IconButton
                ...
                icon={<LinkButton className="icon icon--back" width={16} />}
              />
            </div>
          </div>
        </div>
